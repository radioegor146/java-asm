...
{
    internal class TypeAnnotationNode
    {
        public TargetType TargetType { get; set; }

        public ITypeAnnotationTarget Target { get; set; }
        ...
        public static TypeAnnotationNode Parse(Stream stream, ClassReaderState readerState, AttributeScope scope)
        {
            ...
            {
                TargetType.GenericClassOrInterfaceDeclaration when scope == AttributeScope.Class => (ITypeAnnotationTarget) new TypeParameterTarget(),
        ...
        public void Write(Stream stream, ClassWriterState writerState, AttributeScope scope)
        {
