...
{
    internal class RuntimeInvisibleTypeAnnotationsAttribute : CustomAttribute
    {
    ...
    {
        public RuntimeInvisibleTypeAnnotationsAttribute Parse(AttributeNode attributeNode, ClassReaderState readerState, AttributeScope scope)
        {
